...
contract Enemy is Character {
  ...
  constructor(uint8 _level, address _items, Equipment memory _equippedItems, uint32 _goldReward, uint32 _xpReward, Room _room) Character(_level, _items, _equippedItems) {
    room = _room;
    xpReward = _xpReward;
